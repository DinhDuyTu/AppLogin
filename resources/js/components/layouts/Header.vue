        ...
        <li id="header_inbox_bar" class="dropdown">
          ...
          <ul class="dropdown-menu extended inbox">
            ...
            <li>
              <a href="#">
                <span class="photo">
                  <img alt="avatar" src="Assets-Admin/img/avatar-mini.jpg" />
                </span>
                <span class="subject">
            ...
            <li>
              <a href="#">
                <span class="photo">
                  <img alt="avatar" src="Assets-Admin/img/avatar-mini2.jpg" />
                </span>
                <span class="subject">
                  <span class="from">Jhon Doe</span>
                  <span class="time">10 mins</span>
                </span>
                <span class="message">Hi, Jhon Doe Bhai how are you ?</span>
              </a>
            </li>
            <li>
              <a href="#">
                <span class="photo">
                  <img alt="avatar" src="Assets-Admin/img/avatar-mini3.jpg" />
                </span>
                <span class="subject">
            ...
            <li>
              <a href="#">
                <span class="photo">
                  <img alt="avatar" src="Assets-Admin/img/avatar-mini4.jpg" />
                </span>
                <span class="subject">
